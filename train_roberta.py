...
df_posts_roberta["roberta_pred"] = [ID2LABEL[p] for p in all_preds_posts]
df_posts_roberta["roberta_pred_int"] = all_preds_posts
df_posts_roberta["prob_normal"] = [p[0] for p in all_probs_posts]
df_posts_roberta["prob_hatespeech"] = [p[1] for p in all_probs_posts]
df_posts_roberta["prob_offensive"] = [p[2] for p in all_probs_posts]
...
df_exploded_roberta["roberta_pred"] = [ID2LABEL[p] for p in all_preds_exp]
df_exploded_roberta["roberta_pred_int"] = all_preds_exp
df_exploded_roberta["prob_normal"] = [p[0] for p in all_probs_exp]
df_exploded_roberta["prob_hatespeech"] = [p[1] for p in all_probs_exp]
df_exploded_roberta["prob_offensive"] = [p[2] for p in all_probs_exp]
